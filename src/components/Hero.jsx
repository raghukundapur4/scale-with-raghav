...
function Hero() {
  return (
    <section id="home" className="relative overflow-hidden bg-dark pt-32 pb-20 min-h-screen flex items-center">
      ...
      <div className="relative mx-auto flex max-w-5xl flex-col items-center justify-center px-4 text-center sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 pt-4">
            <a
              href="#work"
              className="glow-primary rounded-full bg-primary px-8 py-4 font-bold text-darker transition hover:scale-105"
            >
              See Our Work
            </a>
            <a
              href="https://wa.me/918971267102"
              className="glass rounded-full px-8 py-4 font-bold text-white transition hover:bg-white/10 hover:glow-border"
            >
              Book A Call
            </a>
          </div>
